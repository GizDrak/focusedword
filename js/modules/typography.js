window.TypographyModule = class TypographyModule {
  ...
  applyVisualSettings() {
    ...
    const fontFamily = s.get('fontFamily');
    const fontSize = s.get('fontSize');
    const lineSpacing = s.get('lineSpacing');
    const letterSpacing = s.get('letterSpacing');
    const margins = s.get('margins');
